...
<div class="flex items-center justify-center h-[70vh] w-[96%] mx-auto w3-animate-zoom md:h-[80vh]">
    <div class="p-1 rounded shadow-lg bg-gradient-to-r from-purple-500 via-green-500 to-blue-500">
      <div class="flex flex-col items-center p-4 space-y-2 bg-white">
        ...
        <h1 class="text-4xl font-montsemibold  text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">Thank You!</h1>
        <p class=" font-montmedium my-2">Your booking is successful, We will contact you shortly for confirmation </p>
