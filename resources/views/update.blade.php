...
<section class="bg-gray-100">
    <div class="mx-auto max-w-screen-lg px-4 py-16 sm:px-6 lg:px-8">
      <div class="flex justify-center w-full">
        ...
        <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12 w-full">
          <form action="/blog/save/{{$blog->id}}" class="space-y-4 w-full" method="post" enctype="multipart/form-data">
            @csrf
            <div>
              ...
              <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div class="space-y-1 text-center">
                  ...
                  <div class="flex text-sm text-gray-600">
                    <label id="file-label" for="blogimg" class="relative cursor-pointer bg-white rounded-md font-medium text-black hover:text-white hover:bg-black border border-black font-montmedium px-1 ">
                        change image
                        <input type="file" name="blogimg"  id="blogimg" class="border-0 hidden">
                      </label>
  ...
  <script>
        let uploader= document.getElementById('blogimg');
