...
@php
    $hero = array('img' => "/images/services/Catalogues-02.webp");
    $height="h-[180px]";
    $data = array('title' => "Catalogues", 'desc'=>"In this dynamic modern world, no one can imagine a business without proper high-end mobile solutions. With massive knowledge and
