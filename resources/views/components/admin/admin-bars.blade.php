  ...
  <div x-data="setup()" :class="{ 'dark': isDark }">
      <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white  text-black ">
        ...
        <div class="fixed w-full flex items-center justify-between h-14 text-white bg-white z-10 px-6">
            ...
            <div>
                <a href="#" class="flex items-center px-1 py-1 text-red-600 hover:text-red-700  text-sm font-montmedium rounded-md hover:bg-red-200">
          ...
          <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
            <ul class="flex flex-col py-4 space-y-1">
              ...
              <li>
                ...
                @endif
                <a href="#" @class(['relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#1976BC]  text-black font-montmedium border-r-4 hover:text-white border-l-4 border-transparent hover:border-white
              ...
              <li>
                <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#1976BC]  text-black font-montmedium border-r-4 hover:text-white border-l-4 border-transparent hover:border-white  pr-6">
                  <span class="inline-flex justify-center items-center ml-4">
